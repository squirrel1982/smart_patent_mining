...
pu.writeGraph2pajekNetFile(g_result_topology,'top'+str(TopN)+'_newSumMethod_hybrid_T1_S0.net')
...
pu.writeGraph2pajekNetFile(g_result_semantics,'top'+str(TopN)+'_newSumMethod_hybrid_T0_S1.net')
num_wcc = nx.number_weakly_connected_components(g_result_semantics)
...
subgraphs = [graph[1][1][0] for graph in topN_path_list]
g_result_semantics = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result_semantics,'top'+str(TopN)+'_newSumMethod_hybrid_T200_S1.net')
...
subgraphs = [graph[1][1][0] for graph in topN_path_list]
g_result_semantics = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result_semantics,'top'+str(TopN)+'_newSumMethod_hybrid_T30_S1.net')
...
subgraphs = [graph[1][1][0] for graph in topN_path_list]
g_result_semantics = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result_semantics,'top'+str(TopN)+'_newSumMethod_hybrid_T50_S1.net')
