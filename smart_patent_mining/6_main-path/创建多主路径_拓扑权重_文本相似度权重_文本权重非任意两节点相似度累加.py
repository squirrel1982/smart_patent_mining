...
pu.writeGraph2pajekNetFile(g_result,'top'+str(TopN)+'_oldSumMethod_hybrid_T1_S0.net')
...
g_result = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result,'top'+str(TopN)+'_oldSumMethod_hybrid_T0_S1.net')
...
subgraphs = [graph[1][1][0] for graph in result[:TopN]]
g_result = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result,'top'+str(TopN)+'_oldSumMethod_hybrid_T20_S1.net')
...
subgraphs = [graph[1][1][0] for graph in result[:TopN]]
g_result = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result,'top'+str(TopN)+'_oldSumMethod_hybrid_T30_S1.net')
...
subgraphs = [graph[1][1][0] for graph in result[:TopN]]
g_result = pu.combine_subGraphArray(subgraphs,roadMap.g)
pu.writeGraph2pajekNetFile(g_result,'top'+str(TopN)+'_oldSumMethod_hybrid_T40_S1.net')